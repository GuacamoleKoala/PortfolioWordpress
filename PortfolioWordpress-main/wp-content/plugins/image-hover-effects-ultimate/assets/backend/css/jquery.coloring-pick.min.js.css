...
._col_pick_tool .col-colorbox {
    background: url(/Portfolio//wp-content/plugins/image-hover-effects-ultimate/assets/backend/css/img/trans_bg.png);
    width: 32px;
}
...
.minicolors-sprite {
    background-image: url(/Portfolio//wp-content/plugins/image-hover-effects-ultimate/assets/backend/css/img/jquery.minicolors.png);
}
...
._colpick_tool_cont .minicolors {
    box-shadow: 0 0 0 2px #dfe0e6;
    border-radius: 2px;
    padding: 3px 3px 2px 3px;
}
 ._colpick_tool_cont .minicolors-grid .minicolors-picker {
    border: solid 1px #bdbdbd;
}
._colpick_tool_cont .minicolors-panel{
    border:none;
}
._colpick_tool_cont .minicolors-inline .minicolors-panel {
    position: relative;
    top: auto;
    left: auto;
    box-shadow: none;
...
._colpick_tool_cont .minicolors-slider .minicolors-picker, 
._colpick_tool_cont .minicolors-opacity-slider .minicolors-picker {
...
._colpick_tool_cont .minicolors-theme-default .minicolors-input {
    height: 25px;
    width: 105px;
    display: inline-block !important;
}
._colpick_tool_cont .minicolors-inline .minicolors-input {
    position: absolute;
    z-index: 1;
    top: 66px;
    left: 226px;
